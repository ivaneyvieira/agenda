...
object Defs {
  ...
  const val vaadin10_version = "14.6.5"
...
dependencies { // Vaadin-on-Kotlin dependency, includes Vaadin
  ...
  //Ebean
  implementation("io.ebean:ebean:12.9.1")
  implementation("io.ebean:ebean-querybean:12.9.1")
  //implementation("io.ebean:ebean-agent:12.9.1")
  implementation("io.ebean:ebean-ddl-generator:12.9.1")
  implementation("io.ebean.tools:finder-generator:12.1.1")
  //annotationProcessor("io.ebean:kotlin-querybean-generator:12.9.1")
  ...
  implementation("org.cups4j:cups4j:0.7.6") // https://mvnrepository.com/artifact/org.jsoup/jsoup
